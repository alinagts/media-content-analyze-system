...
![alt text](https://github.com/SavageVictor/media-content-analyze-system/blob/master/docs/requirements/img/1.jpg?raw=true)
...
![alt text](https://github.com/SavageVictor/media-content-analyze-system/blob/master/docs/requirements/img/2.jpg?raw=true)
...
![alt text](https://github.com/SavageVictor/media-content-analyze-system/blob/master/docs/requirements/img/3.jpg?raw=true)
...
![alt text](https://github.com/SavageVictor/media-content-analyze-system/blob/master/docs/requirements/img/4.jpg?raw=true)
...
![alt text](https://github.com/SavageVictor/media-content-analyze-system/blob/master/docs/requirements/img/5.jpg?raw=true)
...
![alt text](https://github.com/SavageVictor/media-content-analyze-system/blob/master/docs/requirements/img/6.jpg?raw=true)
...
![alt text](https://github.com/SavageVictor/media-content-analyze-system/blob/master/docs/requirements/img/7.jpg?raw=true)
...
![alt text](https://github.com/SavageVictor/media-content-analyze-system/blob/master/docs/requirements/img/8.jpg?raw=true)
...
* На оперативну службу підтримки
* безпечне інформаційне середовище

**Система:**
* Збір, Аналіз, Форматування данних
* Еффективно давати проаналізовану інформацію на запит
